...
<script>
	...
	function main_cat(id){
		...
		$.ajax({
			type: 'POST',
			url: path +'childcategories/dropdownprofilestu1',
			data: {id:id},
	...
	function sub_cat(id){
		...
		$.ajax({
			type: 'POST',
			url: path +'childcategories/degdropdown',
			data: {id:id},
			success: function(data){
	...
	function name_cat(id){

		//alert('ok');
		$.ajax({
			type: 'POST',
			url: path +'childcategories/namecat',
			data: {id:id},
			success: function(data){
				$("#name_cat").html(data);
				$("#catname").remove();
	...
	<!---------------------------------------Name & mobile no show search-->

	function drop_cat(id){

		//alert('ok');
		var vl = $("#EntryformMaincategoryId").val();
		$.ajax({
			type: 'POST',
			dataType: "json",
			url: path +'childcategories/dropdownprofilestu2',
			data: {id:id,childcatId :vl },
			success: function(data){
				var str = '';
				$.each( data, function( key, value ) {
					console.log(value.Subcategory.person_name);
					str += "<div>নাম: "+value.Subcategory.person_name+"</div> "+
						"<div>মোবাইল নং: "+value.Subcategory.cell_no+"</div> ";
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><strong><?php echo __('অভিযোগ দাখিল করুন'); ?></strong></h3>
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-md-4 form-group" style="margin-bottom: 0px; font-size: 15px; text-align: right">
					</div>

					<div class="col-md-4 form-group" id="cat" style="margin-bottom: 0px; font-size: 15px; text-align: right">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4 form-group" style="margin-left: -9px">
						...
						<div class="row">
							<div class="col-md-12 form-group">
								...
								<?php echo $this->Form->input('subcategory_id', array('class'=>'form-control','label'=>false,'id'=>'cat2','type'=>'select','options'=>array())); ?>
								<div id="sub_dropdown" >
						...
						<div class="row">
							<div class="col-md-12 form-group">
								<label>পদবি </label>
								<?php echo $this->Form->input('designation_id', array('class'=>'form-control','id'=>'deg2','label'=>false,'id'=>'deg2','type'=>'select','options'=>array())); ?>
								<div id="deg_dropdown">
						...
						<!--<div class="row">
							<div class="col-md-12 form-group">
								<label>নাম </label>
								<?php /*echo $this->Form->input('name', array('class'=>'form-control','id'=>'catname','label'=>false,'type'=>'select','options'=>array())); */?>
								<div id="name_cat">
					...
					<div class="col-md-4 form-group" id="cat" style="margin-bottom: 0px; font-size: 15px">
					</div>

					<div class="col-md-4 form-group" id="cat4" style="margin-bottom: 0px; font-size: 15px">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6 form-group" style="margin-left: -9px">
						...
						<h4 style="margin-left: 11px; color: #698d2f">নিযুক্তকারী </h4>
						<div class="row">
