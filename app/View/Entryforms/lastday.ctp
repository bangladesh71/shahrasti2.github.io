...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo __('শেষ দিন অভিযোগ  এর তালিকা'); ?></h3>
	...
	<div class="form_top">
		<div class="table-responsive" style=" width: 100%;">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<?php echo $this->Form->create('allsearch',array('class'=>'form-horizontal','url' => array('controller'=>'entryforms','action'=>'lastday'))); ?>
