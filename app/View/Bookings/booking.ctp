...
<div class=col-md-3></div>
	<div class="col-md-6" style="color:red;font-size:15px;min-height:400px;text-align:center;font-size:18px;padding-top:130px">
	Sorry,your reservation can not be completed.You are only allowed to book 1 prime slot per day
	<div class="alert confirm">
	<a onclick="self.history.back();" href="#" class="btn btn-danger">Go Back</a>
	</div>
	</div>
                                          	...
                                          	<div class="row margin-5-0 trainer" style="display: none;">
												...
												<div class="col-md-8"> 
													...
													//pr($trainees);
														...
														//echo $this->Form->input('trainee_id',array('empty'=>array('0'=>'--select--'),'label'=>false,'div'=>false,'class'=>'form-control','required'=>true,'onchange'=>'getTrainerInfo(this.value)'));
													?>
										...
										<div class="col-md-6">
											...
											<div class="row margin-5-0">
                                          	...
                                          	<div class="row margin-5-0" style="display: none;" id="name">
                                                ...
                                                <div class="col-md-8">
                                                      <?php echo $this->Form->input('name',array('type'=>'text','class'=>'form-control rname','label'=>false,'div'=>false));?>
                                                </div>
                                          	</div>
                                        </div>
                                 </div>
