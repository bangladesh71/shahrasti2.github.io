...
<div class="col-md-12">
	 <div class="form-group">                                        
		...
		echo $this->Form->input('paymentType',array('empty'=>array(''=>'--select--'),'type'=>'select','options'=>$paymentType,'label'=>false,'div'=>false,'class'=>'form-control','required'=>true,'onchange'=>"bookingCheckOut('$bid',this.value);"));?>
		</div>             
	</div>
</div>
<div class="col-md-12">
