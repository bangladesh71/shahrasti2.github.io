	...
	<div class="col-md-8">
		...
		<?php echo $this->Form->input('slug',array('type'=>'hidden'));?>
			...
			<div class="panel-body">
				...
				<?php
				echo $this->Form->input('parent_id',array('type'=>'select','options'=>$parentMenus,'label'=>'Parent Menu','div'=>false,'class'=>'form-control','empty' => array('0'=> '--select--'),'required'=>false));
				?>
				<?php
