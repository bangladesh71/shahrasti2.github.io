...
<?php echo $this->Form->create('Contentimage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Contentimage'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Contentimage.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Contentimage.id'))); ?></li>
