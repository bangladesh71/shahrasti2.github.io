<div style="background: #e5e5e5;padding: 20px; text-align: center;font-family: Lucida Sans Unicode">
	...
	<p style="text-align: left;"> You have reserved the tennis court <?php $data['type'];?> for <?php echo date('l,F j, Y',strtotime($data['datetime']));?> <?php echo date('h:i:s A',strtotime($data['datetime']));?>. 
	</p>
