	           ...
	           pr($gallery);
	            ...
	            <div class="col-md-4 image-row">
					<div class="gallery-item gallery-item--compact image-set">
						<a class="example-image-link gallery__image popup-item hover-effect" href="<?php echo $this->webroot?>img/upload/large/<?php echo $imgId;?>.png" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><img class="example-image" src="<?php echo $this->webroot?>img/upload/large/<?php echo $imgId;?>.png" >
						<i class="icon-circle icon-circle--thin fa fa-arrow-right"></i>
						</a>
						
						<div class="gallery__description">
							<a class="gallery__title popup-item--link" href="<?php echo $this->webroot?>img/upload/large/<?php echo $imgId;?>.png" title="<?php echo $title;?>"><?php echo $title;?></a>
