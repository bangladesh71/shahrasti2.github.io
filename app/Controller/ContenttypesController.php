 ...
 */
	...
	public $content_type = array('12'=>'academic');
	public function beforeFilter() {
		parent::beforeFilter();
		$this->set ( 'content_type', $this->content_type );
	}
 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			...
			$this->request->data ['Contenttype'] ['ctype'] = json_encode ( $this->request->data ['Contenttype'] ['ctype'] );
