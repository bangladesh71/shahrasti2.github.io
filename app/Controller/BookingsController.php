 ...
 */
	public function add() {
		...
		$members = $this->Booking->Member->find('list');
		$trainees = $this->Booking->Trainee->find('list');
		$tennises = $this->Booking->Tennise->find('list');
		$this->set(compact('members', 'trainees', 'tennises'));
	}
